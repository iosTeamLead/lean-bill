...
@interface TakeAwayNotification ()

@end

@implementation TakeAwayNotification
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row==2)
    {
        ...
        cell.userAction.text =@"accepted your request to join take away number XXXX";
